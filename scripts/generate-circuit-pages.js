...
const allCircuits = FileAttachment("../data/circuits.json.js").json();
const circuitsGeoJSON = FileAttachment("../data/circuits.json").json();
...
console.log(`\n✅ Generated ${circuits.length} circuit pages`);
