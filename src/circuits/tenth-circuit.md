...
const circuitFeature = circuitsGeoJSON.features.find(f =>
  f.properties.Name === "Tenth Circuit"
);
```
...
const recentCases = caseData.recentCases.filter(c => c.circuit === "Tenth Circuit");
const citedCases = caseData.mostCitedCases.filter(c => c.circuit === "Tenth Circuit");
```

<div class="circuit-header">
  <p class="circuit-intro">
    The Tenth Circuit is one of the thirteen United States Courts of Appeals.
  </p>
