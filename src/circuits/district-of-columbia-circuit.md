...
const circuitFeature = circuitsGeoJSON.features.find(f =>
  f.properties.Name === "District of Columbia Circuit"
);
```
...
const recentCases = caseData.recentCases.filter(c => c.circuit === "District of Columbia Circuit");
const citedCases = caseData.mostCitedCases.filter(c => c.circuit === "District of Columbia Circuit");
```

<div class="circuit-header">
  <p class="circuit-intro">
    The District of Columbia Circuit is one of the thirteen United States Courts of Appeals.
  </p>
