...
const circuitFeature = circuitsGeoJSON.features.find(f =>
  f.properties.Name === "Third Circuit"
);
```
...
const recentCases = caseData.recentCases.filter(c => c.circuit === "Third Circuit");
const citedCases = caseData.mostCitedCases.filter(c => c.circuit === "Third Circuit");
```

<div class="circuit-header">
  <p class="circuit-intro">
    The Third Circuit is one of the thirteen United States Courts of Appeals.
  </p>
