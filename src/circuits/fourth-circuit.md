...
const circuitFeature = circuitsGeoJSON.features.find(f =>
  f.properties.Name === "Fourth Circuit"
);
```
...
const recentCases = caseData.recentCases.filter(c => c.circuit === "Fourth Circuit");
const citedCases = caseData.mostCitedCases.filter(c => c.circuit === "Fourth Circuit");
```

<div class="circuit-header">
  <p class="circuit-intro">
    The Fourth Circuit is one of the thirteen United States Courts of Appeals.
  </p>
