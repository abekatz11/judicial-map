...
const circuitFeature = circuitsGeoJSON.features.find(f =>
  f.properties.Name === "Fifth Circuit"
);
```
...
const recentCases = caseData.recentCases.filter(c => c.circuit === "Fifth Circuit");
const citedCases = caseData.mostCitedCases.filter(c => c.circuit === "Fifth Circuit");
```

<div class="circuit-header">
  <p class="circuit-intro">
    The Fifth Circuit is one of the thirteen United States Courts of Appeals.
  </p>
